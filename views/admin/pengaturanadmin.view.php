    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          ...
          <p class="pageheader-text">Pengaturan Admin</p>
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php?hal=penulis" class="breadcrumb-link">Pengaturan Admin</a></li>
      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
          <div class="card">
            ...
            <div class="card-body">
              <form action="index.php?hal=pengaturan&action=simpanBioAdmin" method="post">
                <div class="form-group">
                  <label for="inputText3" class="col-form-label">Username Admin</label>
                  <input disabled required name="username" id="inputText3" type="text" class="form-control" value="<?= $data['account']->username_admin ?>">
                  <input name="username_admin" id="inputText3" type="hidden" class="form-control" value="<?= $data['account']->username_admin ?>">
                </div>
                <div class="form-group">
                  <label for="inputText3" class="col-form-label">Nama Admin</label>
                  <input required name="nama_admin" id="inputText3" type="text" class="form-control" value="<?= $data['account']->nama_admin ?>">
                </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="index.php?hal=pengaturan&action=simpanpassword" method="post" enctype="multipart/form-data">
                <input name="id" id="inputText3" type="hidden" class="form-control" value="<?= $data['account']->id_admin ?>"/>
                <div class="form-group">
