      ...
      <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form action="index.php?hal=admin&action=simpan" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="inputText3" class="col-form-label">Username</label>
                  <input <?php if($data['action'] == "edit") echo "disabled";?> required name="username_admin" id="inputText3" type="text" class="form-control" value="<?= $data['action'] == "edit" ? $data['admin']->username_admin : "" ?>">
                </div>
                <div class="form-group">
                  <label for="inputText3" class="col-form-label">Nama Admin</label>
                  <input required name="nama_admin" id="inputText3" type="text" class="form-control" value="<?= $data['action'] == "edit" ? $data['admin']->nama_admin : "" ?>">
                </div>
                <?php
                if($data['action'] == "edit"){
                  ?>
                    <input type="hidden" name="id" value="<?= $data["admin"]->id_admin ?>">
                  ...
                  <div class="custom-file mb-3">
                    <input type="submit" href="#" class="centerHorizontal btn btn-primary" value="Tambahkan"/>
                  </div>
                  <?php
                }
                ?>
